...
Welcome to ``bigfood_db`` contributor's guide.
...
If you experience bugs or general issues with ``bigfood_db``, please have a look
...
You can help improve ``bigfood_db`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``bigfood_db`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``bigfood_db``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n bigfood_db python=3 six virtualenv pytest pytest-cov
    conda activate bigfood_db
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/bigfood_db.git
    cd bigfood_db
...
#. Install |pre-commit|_::
   ...
   ``bigfood_db`` comes with a lot of hooks configured to automatically help the
...
#. Make sure to fetch all the tags from the upstream repository_.
   ...
   ``.eggs``, as well as the ``*.egg-info`` folders in the ``bigfood_db`` folder or
...
.. _repository: https://github.com/<USERNAME>/bigfood_db
.. _issue tracker: https://github.com/<USERNAME>/bigfood_db/issues
.. <-- end -->
